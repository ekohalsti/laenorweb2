...
import Messages exposing (Msg(NoOp, TagGroupsMsg))
import TagGroups.Update
        ...
        TagGroupsMsg subMsg ->
            ...
            let
                ...
                ( newTagGroups, cmd ) =
                    ...
                    TagGroups.Update.update subMsg model.tagGroups
            ...
            in
                ...
                ( newModel, Cmd.map TagGroupsMsg cmd )
